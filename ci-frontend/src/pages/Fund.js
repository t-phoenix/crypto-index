...
export default function Fund() {
    ...
    const tokensList2 =[{name:"Crypto Index", symbol: "INDEX", src: blueLogo , address: "", balance: "2", value: "200", price: "100"}] 
  ...
  return (
    <div className="main-content">
      ...
      <div className="trade-box">
        ...
        <OutBoxput inputAmout={outputAmout} setInputAmount={setOutputAmount} inputAmtValue={outputAmtValue} setInputAmtValue={setOutputAmtValue} selectedAsset={selectedOutputAsset} setSelectedAsset={setSelectedOutputAsset} tokensList={isInputINDEX? tokensList: tokensList2}/>
        <br/>
